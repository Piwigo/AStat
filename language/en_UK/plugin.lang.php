...
$lang['AStat_tools_deleted_user_nfo0'] = "This function forces to <i>guest</i> a user ID generated as event in the history whose account has been since deleted.";
$lang['AStat_tools_deleted_user_nfo1'] = "%s unknown user ID among history events impacting %s events : <ul>%s</ul>";
...
$lang['AStat_tools_deleted_picture_nfo0'] = "Impacts events in the history referring to images that no longer exist, a <i>picture [Id #0] no longer exists in the base</i>"; // v1.3.0
$lang['AStat_tools_deleted_picture_nfo1'] = "%s unknow picture  Id among history of event impacting %s events : <ul>%s</ul>";
...
$lang['AStat_tools_general_nfo_nfo'] = "<ul><li>%s events are present in the history</li>
...
$lang['AStat_tools_deleted_category_nfo1'] = "%s unexisting directory are listed among events in history and impact %s events : <ul>%s</ul>";
