...
$lang['AStat_tools_deleted_user_nfo0'] = "Cette fonction force à <i>guest</i> l'identifiant d'un utilisateur ayant généré un évènement dans l'historique et dont le compte a été supprimé depuis.";
$lang['AStat_tools_deleted_user_nfo1'] = "%s identifiants inconnus sont présents dans les évènements de l'historique et impactent %s évènements : <ul>%s</ul>";
...
$lang['AStat_tools_deleted_picture_nfo0'] = "Affecte pour les évènements de l'historique référencants des images qui n'existent plus, un identifiant <i>photo n'existe plus en base [ Id #0 ]</i>."; // v1.3.0
$lang['AStat_tools_deleted_picture_nfo1'] = "%s images inexistantes sont présentes dans les évènements de l'historique et impactent %s évènements : <ul>%s</ul>";
...
$lang['AStat_tools_deleted_picture_prepare_action'] = "<u>Avant</u> de procéder à la synchronisation : préparer <i>AStat</i>";
$lang['AStat_tools_deleted_picture_do_action'] = "<u>Après</u> avoir procédé à la synchronisation : réassocier les nouveaux identifiant d'images aux évènements de l'historique ";
