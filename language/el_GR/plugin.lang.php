...
// | USA.                                                                  |
// +-----------------------------------------------------------------------+
$lang['AStat_SeeTimeRequests'] = 'Εμφάνιση χρόνου εκτέλεσης των αιτημάτων';
$lang['AStat_RefImageLabel'] = ' Όνομα Κατηγορίας / εικόνας';
$lang['AStat_RefIPLabel'] = 'Χρήστης / διεύθυνση IP';
$lang['AStat_PeriodPerDefault_year'] = 'Το τρέχον έτος';
$lang['AStat_PeriodPerDefault_month'] = 'Ο τρέχον μήνας';
$lang['AStat_PeriodPerDefault_global'] = 'Συνολικά';
$lang['AStat_PeriodPerDefault_day'] = 'Η τρέχουσα ημέρα';
$lang['AStat_PeriodPerDefault_all'] = 'Όλα τα έτη';
$lang['AStat_PeriodPerDefault'] = 'Προεπιλεγμένη περίοδος';
$lang['AStat_Nfo_Period'] = 'Για την επιλεγμένη περίοδο, αντιπροσωπεύει τον αριθμό των σελίδων και εικόνων, ως ο αριθμός των διακεκριμένων διευθύνσεων IP που συνδέθηκαν';
$lang['AStat_Nfo_Image'] = 'Για την επιλεγμένη περίοδο, ο αριθμός εμφανίσεων για κάθε εικόνα, ως παράσταση επί τις εκατό του αριθμού των εμφανίσεων για το συνολικό αριθμό εμφανίσεων';
$lang['AStat_Nfo_IP'] = 'Για την επιλεγμένη περίοδο, αντιπροσωπεύει τον αριθμό των σελίδων και εικόνων που έχει δει μια διεύθυνση IP';
$lang['AStat_Nfo_Category'] = 'Για την επιλεγμένη περίοδο, αντιπροσωπεύουν τοις εκατό του αριθμού των σελίδων και εικόνων σε επισκέψεις ανά κατηγορία, ως ο μέσος αριθμός εμφανίσεων ανά εικόνα';
$lang['AStat_NbImgPerPages'] = 'Αριθμός εικόνων ανά σελίδα';
$lang['AStat_NbIPPerPages'] = 'Αριθμός IP ανά σελίδα';
$lang['AStat_NbCatPerPages'] = 'Αριθμός κατηγοριών ανά σελίδα';
$lang['AStat_MouseOverColor'] = 'Σειρά Mouse over';
$lang['AStat_MaxBarWidth'] = 'Μέγιστο πλάτος μπάρας (σε πίξελ)';
$lang['AStat_IP_geolocalisation'] = 'Γεωεντοπισμός';
$lang['AStat_IP_blacklist'] = 'Προσθήκη στη μαύρη λίστα';
$lang['AStat_DelIP'] = 'Διαγραφή από τη μαύρη λίστα';
$lang['AStat_DefaultSortImg'] = 'Προεπιλεγμένη ταξινόμηση';
$lang['AStat_DefaultSortIP'] = 'Προεπιλεγμένη ταξινόμηση';
$lang['AStat_DefaultSortCat'] = 'Προεπιλεγμένη ταξινόμηση';
$lang['AStat_BlackListedIP'] = 'Μαύρη λίστα IP';
$lang['AStat_BarColor_Pages'] = 'Αριθμός σελίδων';
$lang['AStat_BarColor_Img'] = 'Αριθμός φωτογραφιών';
$lang['AStat_BarColor_IP'] = 'Αριθμός των διευθύνσεων IP';
$lang['AStat_BarColor_Cat'] = 'Αριθμός των κατηγοριών';
$lang['AStat_AddIP'] = 'Προσθήκη στη μαύρη λίστα';
$lang['AStat_period_label_months'] = 'Μήνες';
$lang['AStat_period_label_hours'] = 'Ώρες';
$lang['AStat_period_label_global'] = 'Γενική';
$lang['AStat_period_label_days'] = 'Ημέρες';
$lang['AStat_period_label_all'] = 'Όλο το χρόνο';
$lang['AStat_pages_label'] = 'Σελίδες';
$lang['AStat_page_label'] = 'Σελίδα';
$lang['AStat_nofilter'] = '--- Κανένα φίλτρο ---';
$lang['AStat_nb_total_ip'] = 'Συνολικός αριθμός διευθύνσεων IP';
$lang['AStat_nb_total_image'] = 'Συνολικός αριθμός των εικόνων';
$lang['AStat_nb_total_category'] = 'Συνολικός αριθμός των κατηγοριών';
$lang['AStat_month_of_year_9'] = 'Σεπτέμβριος';
$lang['AStat_month_of_year_8'] = 'Αύγουστος';
$lang['AStat_month_of_year_7'] = 'Ιούλιος';
$lang['AStat_month_of_year_6'] = 'Ιούνιος';
$lang['AStat_month_of_year_5'] = 'Μάιος';
$lang['AStat_month_of_year_4'] = 'Απρίλιος';
$lang['AStat_month_of_year_3'] = 'Μάρτιος';
$lang['AStat_month_of_year_2'] = 'Φεβρουάριος';
$lang['AStat_month_of_year_12'] = 'Δεκέμβριος';
$lang['AStat_month_of_year_11'] = 'Νοέμβριος';
$lang['AStat_month_of_year_10'] = 'Οκτώβριος';
$lang['AStat_month_of_year_1'] = 'Ιανουάριος';
$lang['AStat_gpc2_not_installed'] = 'Το πρόσθετο \'Grum Plugins Classes 2\' (έκδοση >= %s) χρειάζεται για να εγκαταστήσετε το AStat';
$lang['AStat_general_config'] = 'Γενικές ρυθμίσεις';
$lang['AStat_events'] = 'συμβάντα';
$lang['AStat_event'] = 'συμβάν';
$lang['AStat_enableddisabled_true'] = 'Το Φίλτρο είναι ενεργοποιημένο ';
$lang['AStat_enableddisabled_invert'] = 'Το Φίλτρο είναι αντεστραμμένο ';
$lang['AStat_enableddisabled_false'] = 'Το Φίλτρο είναι απενεργοποιημένο';
$lang['AStat_do_save'] = 'Αποθήκευση';
$lang['AStat_deleted_user'] = 'Χρήστης διαγραμμένος';
$lang['AStat_day_of_week_4'] = 'Πέμπτη';
$lang['AStat_day_of_week_0'] = 'Κυριακή';
$lang['AStat_day_of_week_1'] = 'Δευτέρα';
$lang['AStat_day_of_week_2'] = 'Τρίτη';
$lang['AStat_day_of_week_3'] = 'Τετάρτη';
$lang['AStat_day_of_week_5'] = 'Παρασκευή';
$lang['AStat_day_of_week_6'] = 'Σάββατο';
$lang['AStat_deleted_picture'] = 'Η εικόνα δεν υπάρχει πλέον';
$lang['AStat_date_time_format'] = 'Y/d/m H:i:s';
$lang['AStat_confignotsaved'] = 'Παρουσιάστηκε σφάλμα, οι ρυθμίσεις δεν αποθηκεύτηκαν';
$lang['AStat_config_title'] = 'Ρυθμίσεις AStat';
$lang['AStat_config_saved'] = 'Οι ρυθμίσεις αποθηκεύτηκαν!';
$lang['AStat_config_colors_and_graph'] = 'Χρώμα & ρυθμίσεις γραφικών';
$lang['AStat_config'] = 'Ρυθμίσεις';
$lang['AStat_catfilter_list'] = 'Εφαρμογή φίλτρου σε κατηγορίες';
$lang['AStat_by_period'] = 'Με την περίοδο';
$lang['AStat_by_ip'] = 'κατά IP';
$lang['AStat_by_category'] = 'κατά κατηγορία';
$lang['AStat_by_image'] = 'κατά εικόνα';
$lang['AStat_adviser_not_authorized'] = 'Η Δράση ματαιώθηκε: το προφίλ σύμβουλος δεν επιτρέπει αυτού του είδους της δράση';
$lang['AStat_SortImgLabel'] = 'Ταξινομημένα κατά';
$lang['AStat_SortIPLabel'] = 'Ταξινομημένα κατά';
$lang['AStat_SortCatLabel'] = 'Ταξινομημένα κατά';
$lang['AStat_ShowThumbImg'] = 'Εμφάνιση μικρογραφίας εικόνας';
$lang['AStat_ShowThumbCat'] = 'Εμφάνιση της μικρογραφίας του εκπροσώπου της κατηγορίας';
$lang['AStat_sortcat_nbpicture'] = 'Μέσος αριθμός προβολών ανά εικόνα';
$lang['AStat_section_web_services'] = 'Πρόσθετο <a href="http://piwigo.org/ext/extension_view.php?eid=171">Web services statistics</a>';
$lang['AStat_section_unknown'] = 'Άγνωστο [%s]';
$lang['AStat_section_tags'] = ' ';
$lang['AStat_section_search'] = ' ';
$lang['AStat_section_recent_pics'] = ' ';
$lang['AStat_section_recent_cats'] = ' ';
$lang['AStat_section_old_deleted_cat'] = 'Δεν είναι δυνατή η εισαγωγή της παλιάς κατηγορίας';
$lang['AStat_section_most_visited'] = ' ';
$lang['AStat_section_most_commented'] = 'Πρόσθετο <a href="http://piwigo.org/ext/extension_view.php?eid=145">Most Commented</a>';
$lang['AStat_section_list'] = ' ';
$lang['AStat_section_label'] = 'Τμήμα';
...
$lang['AStat_tools_deleted_picture_ok0'] = 'Η επίχριση του πίνακα πέτυχε, τα αρχεία μπορούν να αναδιοργανωθούν στον server';
